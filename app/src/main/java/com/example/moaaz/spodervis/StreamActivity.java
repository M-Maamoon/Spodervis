...
public class StreamActivity extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, IVideoPlayer {

    public final static String TAG = "LibVLCAndroidSample/VideoActivity";

    public final static String LOCATION = "com.example.moaaz.spodervis.StreamActivity.location";
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(StreamActivity owner) {
